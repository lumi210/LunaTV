          ...
          >
            ...
            <div className='space-y-2 text-sm'>
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2 gap-x-2 gap-y-1'>
                ...
                <div className='text-gray-900 dark:text-gray-100 text-xs break-all mb-1 sm:mb-0'>
                ...
                <div className='text-gray-900 dark:text-gray-100 break-all mb-1 sm:mb-0'>
                  ...
                  {((diagnoseResult as any).spider_url ||
                    ...
                    <div className='mt-2 p-2 bg-blue-50 dark:bg-blue-900/20 rounded text-xs'>
                      ...
                      <div className='space-y-0.5 text-blue-700 dark:text-blue-300'>
                        ...
                        {(diagnoseResult as any).spider_md5 && (
                          <div className='break-all'>
                            • MD5: {(diagnoseResult as any).spider_md5}
                          </div>
                        )}
