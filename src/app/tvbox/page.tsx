          ...
          <div className='p-6'>
            ...
            {activeTab === 'basic' && (
              <div>
                ...
                {jarRefreshMsg && (
                  <div
                    className={`mb-4 p-3 rounded-lg ${jarRefreshMsg.startsWith('✓') ? 'bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300' : 'bg-red-50 dark:bg-red-900/20 text-red-700 dark:text-red-300'}`}
                  >
                    {jarRefreshMsg}
                  </div>
                )}
                        ...
                        <div className='p-4 bg-linear-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border border-blue-200 dark:border-blue-700'>
                          ...
                          <div className='grid grid-cols-1 md:grid-cols-2 gap-3 text-sm'>
                            ...
                            <div>
                              ...
                              <div
                                className={`font-medium ${diagnosisResult.spider_cached ? 'text-green-600 dark:text-green-400' : 'text-yellow-600 dark:text-yellow-400'}`}
                              >
                            ...
                            <div>
                              ...
                              <div className='text-gray-900 dark:text-gray-100 font-medium'>
                                {diagnosisResult.spider_real_size
                                  ? `${Math.round(diagnosisResult.spider_real_size / 1024)}KB`
                                  : 'unknown'}
                              </div>
                            </div>
                            <div>
                              ...
                              <div
                                className={`font-medium ${diagnosisResult.spider_tried && diagnosisResult.spider_tried > 2 ? 'text-yellow-600 dark:text-yellow-400' : 'text-green-600 dark:text-green-400'}`}
                              >
                            ...
                            <div>
                              ...
                              <div
                                className={`font-medium ${diagnosisResult.spider_success ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}
                              >
                      ...
                      <>
                        ...
                        <div className='p-4 bg-linear-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg border border-blue-200 dark:border-blue-700'>
                          ...
                          <div className='grid grid-cols-1 md:grid-cols-2 gap-3 text-sm'>
                            <div>
                              ...
                              <div className='text-gray-900 dark:text-gray-100 font-medium'>
                                {smartHealthResult.network.environment ===
                                'domestic'
                                  ? '🏠 国内网络'
                                  : '🌍 国际网络'}
                              </div>
                          ...
                          <div className='flex items-center justify-between'>
                            <div>
                              ...
                              <div className='text-sm text-gray-600 dark:text-gray-400'>
                                ...
                                {smartHealthResult.reachability.total_tested}{' '}
                                源可用
                              </div>
                            </div>
                            <div className='text-center'>
                              ...
                              <div className='text-xs text-gray-500 dark:text-gray-400 mt-1'>
                                {smartHealthResult.status.overall ===
                                'excellent'
                                  ? '优秀'
                                ...
                                >
                                  <div className='flex items-center gap-2 flex-1 min-w-0'>
                                    ...
                                    <div className='flex-1 min-w-0'>
                                      ...
                                      {test.error && (
                                        <div className='text-xs text-red-500 dark:text-red-400 break-words [overflow-wrap:anywhere]'>
                                          {test.error}
                                        </div>
                                      )}
                                    </div>
                        ...
                        <div className='p-4 bg-gray-50 dark:bg-gray-700 rounded-lg'>
                          ...
                          <div className='grid grid-cols-1 md:grid-cols-2 gap-2 text-sm'>
                            ...
                            <div className='text-gray-900 dark:text-gray-100 font-medium'>
                              {Math.round(
                                smartHealthResult.spider.current.size / 1024,
                              )}
                              KB
                            </div>
                            <div className='text-gray-600 dark:text-gray-400'>
                    ...
                    {jarFixResult.error ? (
                      ...
                      <>
                          ...
                          <div className='flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3'>
                            <div>
                              ...
                              <div className='text-sm text-gray-600 dark:text-gray-400 mt-1'>
                                平均响应:{' '}
                                {Math.round(
                                  jarFixResult.summary.avg_response_time,
                                )}
                                ms
                              </div>
                            </div>
                            <div
                              className={`text-2xl font-bold ${
                                jarFixResult.status.network_quality === 'good'
                                  ? 'text-green-600 dark:text-green-400'
                                  : jarFixResult.status.network_quality ===
                                      'fair'
                                    ? 'text-yellow-600 dark:text-yellow-400'
                                    : 'text-red-600 dark:text-red-400'
                              }`}
                                ...
                                <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2'>
                                  <div className='flex items-center gap-2 flex-1 min-w-0'>
                                    ...
                                    <div className='flex-1 min-w-0'>
                                      ...
                                      {test.error && (
                                        <div className='text-xs text-red-600 dark:text-red-400 mt-1 break-words [overflow-wrap:anywhere]'>
                                          {test.error}
                                        </div>
                                      )}
                                    </div>
                        ...
                        <div className='space-y-3'>
                          ...
                          {/* 配置建议 */}
                          {jarFixResult.recommendations.configuration.length >
                            0 && (
                      ...
                      <>
                        ...
                        <div className='grid grid-cols-2 sm:grid-cols-4 gap-3'>
                          ...
                          <div className='p-3 bg-linear-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-lg text-center'>
                            ...
                            <div className='text-xs text-green-700 dark:text-green-300 mt-1 break-words'>
                              可用源
                            </div>
                          </div>
                          ...
                          <div className='p-3 bg-linear-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-lg text-center'>
                            <div className='text-xl sm:text-2xl font-bold text-purple-600 dark:text-purple-400 break-words'>
                              {Math.round(
                                deepDiagnosticResult.summary
                                  .averageResponseTime,
                              )}
                              ms
                            </div>
                            <div className='text-xs text-purple-700 dark:text-purple-300 mt-1 break-words'>
                              平均响应
                            </div>
                          </div>
                        </div>
